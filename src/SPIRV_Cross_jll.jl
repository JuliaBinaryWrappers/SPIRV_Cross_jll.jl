...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import SPIRV_Cross_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("b5475fc2-85c9-5de8-8430-71c9b732ec36"))
platforms = [Pkg.Artifacts.unpack_platform(e, "SPIRV_Cross", artifacts_toml) for e in artifacts["SPIRV_Cross"]]
...
if best_platform === nothing
    @debug("Unable to load SPIRV_Cross; unsupported platform $(triplet(platform_key_abi()))")
else
