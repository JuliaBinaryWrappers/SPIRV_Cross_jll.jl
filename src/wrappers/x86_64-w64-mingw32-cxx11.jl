# Autogenerated wrapper script for SPIRV_Cross_jll for x86_64-w64-mingw32-cxx11
...
const libspirv_cross_splitpath = ["bin", "libspirv-cross-c-shared.dll"]
...
const libspirv_cross = "libspirv-cross-c-shared.dll"


# Relative path to `spirv_cross`
const spirv_cross_splitpath = ["bin", "spirv-cross.exe"]
